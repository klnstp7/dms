...
import com.yunfang.dms.entity.ReportCaseCond.Criteria;
import com.yunfang.dms.entity.ReportCaseCond.Criterion;
import com.yunfang.dms.entity.ReportCaseCond;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class ReportCaseSqlProvider {

    public String countByExample(ReportCaseCond example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("reportcase");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(ReportCaseCond example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("reportcase");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(ReportCase record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("reportcase");
    ...
    public String selectByExampleWithBLOBs(ReportCaseCond example) {
        SQL sql = new SQL();
    ...
    public String selectByExample(ReportCaseCond example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("ID");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ReportCase record = (ReportCase) parameter.get("record");
        ReportCaseCond example = (ReportCaseCond) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("reportcase");
    ...
    public String updateByPrimaryKeySelective(ReportCase record) {
        SQL sql = new SQL();
        sql.UPDATE("reportcase");
    ...
    protected void applyWhere(SQL sql, ReportCaseCond example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
