...
import com.yunfang.dms.entity.InquiryDataCond.Criteria;
import com.yunfang.dms.entity.InquiryDataCond.Criterion;
...
public class InquiryDataSqlProvider {
    ...
    public String countByExample(InquiryDataCond example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("inquirydata");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(InquiryDataCond example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("inquirydata");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(InquiryData record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("inquirydata");
    ...
    public String selectByExampleWithBLOBs(InquiryDataCond example) {
        SQL sql = new SQL();
    ...
    public String selectByExample(InquiryDataCond example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("ID");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        InquiryData record = (InquiryData) parameter.get("record");
        InquiryDataCond example = (InquiryDataCond) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("inquirydata");
    ...
    public String updateByPrimaryKeySelective(InquiryData record) {
        SQL sql = new SQL();
        sql.UPDATE("inquirydata");
    ...
    protected void applyWhere(SQL sql, InquiryDataCond example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
