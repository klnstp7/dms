...
import com.yunfang.dms.entity.UnitBaseDataHisCond.Criteria;
import com.yunfang.dms.entity.UnitBaseDataHisCond.Criterion;
import com.yunfang.dms.entity.UnitBaseDataHisCond;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class UnitBaseDataHisSqlProvider {

    public String countByExample(UnitBaseDataHisCond example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("unitbasedata_his");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(UnitBaseDataHisCond example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("unitbasedata_his");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(UnitBaseDataHis record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("unitbasedata_his");
        
        if (record.getUnitId() != null) {
            sql.VALUES("UnitID", "#{unitId,jdbcType=BIGINT}");
        }
    ...
    public String selectByExampleWithBLOBs(UnitBaseDataHisCond example) {
        SQL sql = new SQL();
    ...
    public String selectByExample(UnitBaseDataHisCond example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("ID");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        UnitBaseDataHis record = (UnitBaseDataHis) parameter.get("record");
        UnitBaseDataHisCond example = (UnitBaseDataHisCond) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("unitbasedata_his");
        ...
        if (record.getUnitId() != null) {
            sql.SET("UnitID = #{record.unitId,jdbcType=BIGINT}");
        }
    ...
    public String updateByPrimaryKeySelective(UnitBaseDataHis record) {
        SQL sql = new SQL();
        sql.UPDATE("unitbasedata_his");
        
        if (record.getUnitId() != null) {
            sql.SET("UnitID = #{unitId,jdbcType=BIGINT}");
        }
    ...
    protected void applyWhere(SQL sql, UnitBaseDataHisCond example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
