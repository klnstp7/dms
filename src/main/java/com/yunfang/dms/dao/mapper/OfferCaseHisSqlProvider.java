...
import com.yunfang.dms.entity.OfferCaseHisCond.Criteria;
import com.yunfang.dms.entity.OfferCaseHisCond.Criterion;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class OfferCaseHisSqlProvider {
    public String countByExample(OfferCaseHisCond example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(OfferCaseHisCond example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(OfferCaseHis record) {
        SQL sql = new SQL();
        ...
        if (record.getOfferCaseId() != null) {
            sql.VALUES("OfferCaseId", "#{OfferCaseId,jdbcType=INTEGER}");
        }
        ...
        if (record.getOperator() != null) {
            sql.VALUES("Operator", "#{operator,jdbcType=TIMESTAMP}");
        }
    ...
    public String selectByExampleWithBLOBs(OfferCaseHisCond example) {
        SQL sql = new SQL();
    ...
    public String selectByExample(OfferCaseHisCond example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("ID");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        OfferCaseHis record = (OfferCaseHis) parameter.get("record");
        OfferCaseHisCond example = (OfferCaseHisCond) parameter.get("example");
        ...
        if (record.getOfferCaseId() != null) {
            sql.SET("OfferCaseId = #{record.offerCaseId,jdbcType=INTEGER}");
        }
        ...
        if (record.getOperator() != null) {
            sql.SET("Operator = #{record.operator,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByExample(Map<String, Object> parameter) {
        ...
        sql.SET("OfferTime = #{record.offerTime,jdbcType=TIMESTAMP}");
        sql.SET("DataSource = #{record.dataSource,jdbcType=VARCHAR}");
        sql.SET("CompanyID = #{record.offerCaseId,jdbcType=INTEGER}");
        sql.SET("CreateDateTime = #{record.createDateTime,jdbcType=TIMESTAMP}");
        sql.SET("Operator = #{record.operator,jdbcType=TIMESTAMP}");
    ...
    public String updateByPrimaryKeySelective(OfferCaseHis record) {
        SQL sql = new SQL();
        sql.UPDATE("offercase_his");
        ...
        if (record.getOfferCaseId() != null) {
            sql.SET("CompanyID = #{offerCaseId,jdbcType=INTEGER}");
        }
        ...
        if (record.getOperator() != null) {
            sql.SET("Operator = #{operator,jdbcType=TIMESTAMP}");
        }
    ...
    protected void applyWhere(SQL sql, OfferCaseHisCond example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
