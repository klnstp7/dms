...
import com.yunfang.dms.entity.HouseBaseDataHisCond.Criteria;
import com.yunfang.dms.entity.HouseBaseDataHisCond.Criterion;
import com.yunfang.dms.entity.HouseBaseDataHisCond;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class HouseBaseDataHisSqlProvider {

    public String countByExample(HouseBaseDataHisCond example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("housebasedata_his");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(HouseBaseDataHisCond example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("housebasedata_his");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(HouseBaseDataHis record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("housebasedata_his");
        
        if (record.getHouseId() != null) {
            sql.VALUES("HouseID", "#{houseId,jdbcType=BIGINT}");
        }
    ...
    public String selectByExampleWithBLOBs(HouseBaseDataHisCond example) {
        SQL sql = new SQL();
    ...
    public String selectByExample(HouseBaseDataHisCond example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("ID");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        HouseBaseDataHis record = (HouseBaseDataHis) parameter.get("record");
        HouseBaseDataHisCond example = (HouseBaseDataHisCond) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("housebasedata_his");
        ...
        if (record.getHouseId() != null) {
            sql.SET("HouseID = #{record.houseId,jdbcType=BIGINT}");
        }
    ...
    public String updateByPrimaryKeySelective(HouseBaseDataHis record) {
        SQL sql = new SQL();
        sql.UPDATE("housebasedata_his");
        
        if (record.getHouseId() != null) {
            sql.SET("HouseID = #{houseId,jdbcType=BIGINT}");
        }
    ...
    protected void applyWhere(SQL sql, HouseBaseDataHisCond example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
