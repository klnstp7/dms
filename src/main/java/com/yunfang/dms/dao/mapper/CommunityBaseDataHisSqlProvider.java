...
import com.yunfang.dms.entity.CommunityBaseDataHisCond.Criteria;
import com.yunfang.dms.entity.CommunityBaseDataHisCond.Criterion;
import com.yunfang.dms.entity.CommunityBaseDataHisCond;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class CommunityBaseDataHisSqlProvider {

    public String countByExample(CommunityBaseDataHisCond example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("communitybasedata_his");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(CommunityBaseDataHisCond example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("communitybasedata_his");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(CommunityBaseDataHis record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("communitybasedata_his");
        
        if (record.getCommunityid() != null) {
            sql.VALUES("CommunityID", "#{communityid,jdbcType=BIGINT}");
        }
    ...
    public String selectByExampleWithBLOBs(CommunityBaseDataHisCond example) {
        SQL sql = new SQL();
        ...
        sql.FROM("communitybasedata_his");
        applyWhere(sql, example, false);
    ...
    public String selectByExample(CommunityBaseDataHisCond example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("ID");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CommunityBaseDataHis record = (CommunityBaseDataHis) parameter.get("record");
        CommunityBaseDataHisCond example = (CommunityBaseDataHisCond) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("communitybasedata_his");
        ...
        if (record.getCommunityid() != null) {
            sql.SET("CommunityID = #{record.communityid,jdbcType=BIGINT}");
        }
    ...
    public String updateByPrimaryKeySelective(CommunityBaseDataHis record) {
        SQL sql = new SQL();
        sql.UPDATE("communitybasedata_his");
        
        if (record.getCommunityid() != null) {
            sql.SET("CommunityID = #{communityid,jdbcType=BIGINT}");
        }
    ...
    protected void applyWhere(SQL sql, CommunityBaseDataHisCond example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
