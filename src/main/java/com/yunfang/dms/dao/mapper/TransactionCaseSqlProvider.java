...
import com.yunfang.dms.entity.TransactionCaseCond.Criteria;
import com.yunfang.dms.entity.TransactionCaseCond.Criterion;
import com.yunfang.dms.entity.TransactionCaseCond;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class TransactionCaseSqlProvider {

    public String countByExample(TransactionCaseCond example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("transactioncase");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(TransactionCaseCond example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("transactioncase");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(TransactionCase record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("transactioncase");
    ...
    public String selectByExampleWithBLOBs(TransactionCaseCond example) {
        SQL sql = new SQL();
    ...
    public String selectByExample(TransactionCaseCond example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("ID");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TransactionCase record = (TransactionCase) parameter.get("record");
        TransactionCaseCond example = (TransactionCaseCond) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("transactioncase");
    ...
    public String updateByPrimaryKeySelective(TransactionCase record) {
        SQL sql = new SQL();
        sql.UPDATE("transactioncase");
    ...
    protected void applyWhere(SQL sql, TransactionCaseCond example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
