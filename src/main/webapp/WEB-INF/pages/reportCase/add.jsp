...
<div class="p-5">
    <form id="formData">
        ...
        <div class="form-tb">
            <table>
                <tr>
                    <td class="fuild-width">报告编号</td>
                    <td>
                        <input type="text" name="reportNo" class="inpt" id="reportNo" required="true" />
                    </td>
                    <td class="fuild-width">报告时间</td>
                    <td>
                        <input type="text" name="reportTime" class="inpt" id="reportTime" />
                    </td>
                ...
                <tr>
                    <td class="fuild-width">估价目的</td>
                    <td>
                        <input type="text" name="purpose" class="inpt" id="purpose" />
                    </td>
                    <td class="fuild-width">房屋性质</td>
                    <td>
                        <input type="text" name="houseProperty" class="inpt" id="houseProperty" />
                    </td>
                    <td class="fuild-width">建筑类别</td>
                    <td>
                        <input type="text" name="buildType" class="inpt" id="buildType" />
                    </td>
                </tr>
                <tr>
                    <td class="fuild-width">装修程度</td>
                    <td>
                        <input type="text" name="decoration" class="inpt" id="decoration" />
                    </td>
                    <td class="fuild-width">客户信息</td>
                    <td>
                        <input type="text" name="customerInfo" class="inpt" id="customerInfo" />
                    </td>
                    <td class="fuild-width">户型特性</td>
                    <td>
                        <input type="text" name="roomProperty" class="inpt" id="roomProperty" />
                    </td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        intLaydate('#reportTime');
        $("#uplodata").click(function() {
            if (!$("#formData").valid()) {
                return false;
            }
            $.ajax({
                url: '/reportCase/update',
                type: "post",
                dataType: "json",
                ...
                success: function (data) {
                    if(data){
                        layer.alert("修改成功", {
                            ...
                            parent.search();
                            parent._initHis("#reportCaseHisTable","/reportCase/getHis",id);
