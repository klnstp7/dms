...
<div class="p-5">
    <form id="formData">
        ...
        <div class="form-tb">
            <table>
                <tr>
                    <td class="fuild-width">价格时间</td>
                    <td>
                        <input type="text" name="priceTime" class="inpt laydate-icon" id="priceTime" required="true" />
                    </td>
                ...
                success: function (data) {
                    if(data){
                        layer.alert("修改成功", {
                            ...
                            parent.search();
                            parent._initHis("#transactionCaseHisTable","/transactionCase/getHis",id);
