        ...
        <div class="form-tb">
            <table>
                <tr>
                    ...
                    <td>
                        <input type="text" name="inquirySource" class="inpt" id="inquirySource" required="true" />
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="shichangPrice" class="inpt" id="shichangPrice" />
                    </td>
                </tr>
                <tr>
                    <td class="fuild-width">询价方</td>
                    <td>
                        <input type="text" name="customerOrg" class="inpt" id="customerOrg" />
                    </td>
                    <td class="fuild-width">价格时点</td>
                    <td>
                        <input type="text" name="priceTime" class="inpt laydate-icon" id="priceTime" />
                    </td>
                    <td class="fuild-width">权利属性</td>
                    <td>
                        <input type="text" name="propertyType" class="inpt" id="propertyType" />
                    </td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        intLaydate('#priceTime');
        $("#uplodata").click(function() {
            if (!$("#formData").valid()) {
                return false;
            }
            $.ajax({
                url: '/inquiryData/update',
                type: "post",
                dataType: "json",
                ...
                success: function (data) {
                    if(data){
                        layer.alert("修改成功", {
                            ...
                            parent.search();
                            parent._initHis("#inquiryDataHisTable","/inquiryData/getHis",id);
