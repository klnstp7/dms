        ...
        <div class="form-tb">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="RoomNo" class="inpt" id="RoomNo" />
                    </td>
                    <td class="fuild-width">户名</td>
                    <td>
                        <input type="text" name="RoomName" class="inpt" id="RoomName" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" name="UsedArea" class="inpt" id="UsedArea" />
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="RoomType" class="inpt" id="RoomType" />
                    </td>
                    <td colspan="4"></td>
                </tr>
                <tr>
